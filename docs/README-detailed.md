<!-- Archived long-form README, kept for reference.

The README at the repo root was shortened in 1.8.1 to a one line per feature summary.
This is the full version it replaced: the same information with the long prose, the
release by release narrative, and the detailed install notes. Nothing here is newer than
the root README, so if the two disagree, the root README wins.
-->
...
**Windows · macOS · Linux** &nbsp;·&nbsp; Latest: **[1.8.1 Height](CHANGELOG.md)** &nbsp;·&nbsp; [Getting started](docs/getting-started.mdx)
